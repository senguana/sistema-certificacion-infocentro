					...
					<div class="row">
						<div class="col-sm-8">
							...
							<div class="form-group form-inline">
								<label for="dni_usua"  class="col-md-3 col-form-label">Curso</label>
								<div class="col-md-9 p-0">
									<input type="text" class="form-control input-full" name="dni_usua" placeholder="Ingrese el curso" required="">
								</div>
							</div>
						</div>
