...
<body>
	<div class="container">
		...
		<div class="repre1">
			...
			<p class ="prof1">Presidente del GADPR <br>
			Luz de América</p>
		</div>
		<div class="repre2">
			<hr>
			<p><b>MSc. </b><?php echo $representante1['nombres_repre'] . " ". $representante1['apellidos_repre']; ?></p>
			<p class ="prof2">Rector del ITSAE</p>
		</div>
		<div class="logo1">
			<img src="../../assets/img/infocentro/logo/logo1.jpg" alt="" width="80" height="70">
		</div>
		<div class="logo2">
			<img src="../../assets/img/infocentro/logo/logo2.jpg" alt="" width="80" height="70">
